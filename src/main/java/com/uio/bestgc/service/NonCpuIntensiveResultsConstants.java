...
//    static final Map<String, String> nonCpuIntensiveResults;
   ...
   /* static {
        nonCpuIntensiveResults = new HashMap<>();
        *//*nonCpuIntensiveResults.put("throughput", "CMS");
        nonCpuIntensiveResults.put("pausetime", "ZGC");
        nonCpuIntensiveResults.put("memoryusage", "CMS & Shenandoah");*//*
        //cpuIntensiveResults = Collections.unmodifiableMap(nonCpuIntensiveResults);
        nonCpuIntensiveResults.put("throughput", "PS");
        nonCpuIntensiveResults.put("pausetime", "ZGC");
        nonCpuIntensiveResults.put("memoryusage", "ZGC");
    }*/
