...
data='/Users/sanazt/Documents/bestGc/maxHeap/dacapo/results-copy'
heap = sys.argv[1];
...
g1Per = "{:.5f}".format(np.mean(g1_90Pauses))
print ("G1 : ", g1Per)
psPer = "{:.5f}".format(np.mean(ps_90Pauses))
print ("PS : ", psPer)
shenandoahPer = "{:.5f}".format(np.mean(shenandoah_90Pauses))
print ("Shenandoah : ", shenandoahPer)
zgcPer = "{:.5f}".format(np.mean(zgc_90Pauses))
print ("ZGC : ", zgcPer)
#print(zgc_90Pauses)
